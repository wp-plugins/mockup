<?php wp_nonce_field('mockup_metabox_settings', 'mockup_metabox_settings_nonce');
	...
	// sidebar color
	$mockup_sidebar = get_post_meta($post->ID, '_mockup_sidebar_1', true );
	if(empty($mockup_sidebar)) {
		$mockup_sidebar = get_option('mockup_sidebar');
	}
	...
	<div class="table table_content">
		...
		<table cellspacing="0" cellpadding="0" width="100%">
			...
			<tbody>
				...
				<tr>
					<td><span><strong><?php _e('sidebar Color', 'MockUp'); ?></strong></span></td>
					<td>
						<select id="mockup_sidebar" name="mockup_sidebar_1" width="300" style="width: 300px">
							<option value="light"><?php _e('Light Gray', 'MockUp'); ?></option>
							<option value="dark"<?php if(!empty($mockup_sidebar) && $mockup_sidebar == 'dark') { echo ' selected="selected"'; } ?>><?php _e('Dark Gray', 'MockUp'); ?></option>
						</select>
					</td>
				</tr>
