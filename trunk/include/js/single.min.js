...
function loading(){$("div#load").html('<div class="loading"><i class="fa fa-refresh fa-spin"></i></div>').fadeIn(200)}function slide_menu(e){$("div.slidebox").clearQueue(),"close"==e&&($("div.navbar a").removeClass("active"),$("div.slidebox").animate({"margin-left":"-220px"},1200)),"open"==e&&$("div.slidebox").animate({"margin-left":"0"},1200)}function toggle_menu(e){$("div.slidebox").clearQueue(),loading(),id=$(e).attr("id"),action="mockup_single_"+id,$.ajax({type:"POST",url:ajax_url,data:{action:action,post_id:post_id},success:function(e){$("div#load").hide().html(e).fadeIn(200)}}),$("a.show-title").tooltip("hide"),$("a").removeClass("active"),$(e).addClass("active"),slide_menu("open")}jQuery(document).ready(function(e){e("a.show-title").tooltip({placement:"right"}),e(document).on("click","a#close",function(e){e.preventDefault(),slide_menu("close")}),e(document).keyup(function(e){(27==e.keyCode||37==e.keyCode)&&slide_menu("close")}),e(document).on("click","a.toggle",function(e){e.preventDefault(),toggle_menu(this)}),e(document).on("click","button.submit",function(n){return e(".error").removeClass("error"),has_error=!1,e(this).closest("form").find(".not-empty").each(function(){var n=e(this).val();""==n&&(e(this).addClass("error"),has_error=!0)}),1==has_error?(n.preventDefault(),!1):void 0}),e(document).on("click","button#approve_submit",function(n){return n.preventDefault(),1==has_error?!1:(mockupnonce=e("input#mockupnonce").val(),name=e("input#approve_name").val(),loading(),e.ajax({type:"POST",url:ajax_url,data:{action:"mockup_process_approve",post_id:post_id,mockupnonce:mockupnonce,name:name},success:function(n){e("div#load").hide().html(n).fadeIn(200)}}),void 0)}),e(document).on("click","button#comment_submit",function(n){return n.preventDefault(),1==has_error?!1:(mockupnonce=e("input#mockupnonce").val(),name=e("input#comment_name").val(),text=e("textarea#comment_text").val(),loading(),e.ajax({type:"POST",url:ajax_url,data:{action:"mockup_process_comment",post_id:post_id,mockupnonce:mockupnonce,name:name,text:text},success:function(n){e("div#load").hide().html(n).fadeIn(200)}}),void 0)})});